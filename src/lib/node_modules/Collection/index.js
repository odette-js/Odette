var UNDEFINED, COLLECTION = 'Collection',
    ...
    toArray = _.to.array,
    recreatingSelfCollection = toArray('results,flatten,gather,unique').concat(associatedBuilderKeys('map')),
    recreateSelfConstructor = toArray('eq,where,whereNot').concat(associatedBuilderKeys('filter'), associatedBuilderKeys('filterNegative')),
    ...
    findIteration = toArray('find,findRight,findWhere,findWhereRight').concat(associatedBuilderKeys('find')),
