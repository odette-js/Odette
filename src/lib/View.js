...
app.scope(function (app) {
    ...
    app.undefine(function (app, windo, opts) {
        var $ = opts.$,
            ...
            Region = scopedFactories.Region = Parent.extend('Region', {
            ...
            View = scopedFactories.View = Region.extend('View', {
                Model: Model,
                Child: BOOLEAN_TRUE,
            ...
            RegionManager = scopedFactories[REGION_MANAGER] = factories.Directive.extend(REGION_MANAGER, {
            ...
            BufferedViews = scopedFactories[BUFFERED_VIEWS] = factories.Directive.extend(BUFFERED_VIEWS, {
                constructor: function (instance) {
            ...
            DocumentView = scopedFactories[DOCUMENT_VIEW] = factories.Directive.extend(DOCUMENT_VIEW, {
                regions: noop,
            ...
            DocumentManager = scopedFactories[DOCUMENT_MANAGER] = factories.Directive.extend(DOCUMENT_MANAGER, {
        ...
        documentView = DocumentView({
            el: opts.$.returnsManager(doc),
            id: doc[__ELID__],
            $: opts.$,
            parent: documentManager
        });
        documentView.scopedFactories = scopedFactories;
        ...
        var basicViewTrigger = function (name, e) {
            ...
            Element = factories.Directive.extend(CAPITAL_ELEMENT, {
                ...
                virtualize: function () {
                    var directive = this;
                    var el = directive.el;
                    directive.virtual = (directive.virtual && directive.virtual.tagName === el.tagName) ? directive.virtual : $.document.target.createElement(el.tagName);
                ...
                diff: function () {
                    ...
                    duff(snapshot, function (fn) {
                        thereAreNodeSwaps = fn() || thereAreNodeSwaps;
                    });
