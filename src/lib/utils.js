var factories = {},
    ...
    filter = function (obj, iteratee, context, negated) {
    ...
    filterNegative = function (obj, iteratee, context) {
        return filter(obj, iteratee, context, BOOLEAN_TRUE);
    },
    ...
    }, eachCallers, eachRightCallers, mapCallers, mapRightCallers, findCallers, findLastCallers, filterCallers]);
