var PROMISE = 'Promise',
     ...
     * });
     */
    Promise = module.exports = Directive.extend(PROMISE,
        /**
...
function distillary(fn, arg) {
    return fn ? fn(arg) : arg;
}

function emptyQueue(p, bool, result, original, catching) {
...
function emptiesQueue(p, bool, original, caught) {
