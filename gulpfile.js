var content = ['browserify'],
    ...
    modules = 'beforeSetup setup scopeStart constants utils shims Directives Strings Collection Events Messenger Box Module Looper Promise Ajax Associator DOMM View Buster scopeEnd'.split(' '),
    paths = makePath({
        jsAll: './src/**/*.js',
