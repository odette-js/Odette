var content = ['browserify'],
    ...
    modules = 'setup scopeStart utils shims Strings Collection Events Messenger Box Module LinguisticSequencer Looper Promise Ajax Associator DOMM View Buster scopeEnd'.split(' '),
    paths = makePath({
        jsAll: './src/**/*.js',
